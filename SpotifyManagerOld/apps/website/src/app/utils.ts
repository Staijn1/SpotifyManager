...
const hexToRgb = (hexValue: string): any => {
  let hex;
  hexValue.indexOf('#') === 0
...
const getBreakpoint = (el: any): any => {
...
const setCookie = (name: string, value: any, expire: any) => {
...
const getItemFromStore = (key: any, defaultValue: any, store = localStorage) => {
  try {
