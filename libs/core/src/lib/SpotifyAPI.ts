 ...
 */
export interface SingleShowResponse extends ShowObjectFull {
}
 ...
 */
export interface SingleEpisodeResponse extends EpisodeObjectFull {
}
 ...
 */
export interface ListOfUsersShowsResponse extends PagingObject<SavedShowObject> {
}
 ...
 */
export interface RemoveUsersSavedShowsResponse extends VoidResponse {
}
 ...
 */
export interface CheckUsersSavedShowsResponse extends Array<boolean> {
}
